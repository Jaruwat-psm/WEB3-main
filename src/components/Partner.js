    ...
    <Container maxWidth="xl" sx={{height: matches ? '100vh' : '100%'}}>
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} lg={10}>
          <Typography variant="h4" sx={{color:"white"}}>Partners</Typography>
      ...
      <Grid item lg={3}>
      <Typography variant="h6" sx={{color:"white"}}> Tx Hash</Typography>
      </Grid>
      <Grid item lg={2}>
      <Typography variant="h6" sx={{color:"white"}}>  ID</Typography>
      </Grid>
      <Grid item lg={2}>
      <Typography variant="h6" sx={{color:"white"}}>   Referral Earning</Typography>
      </Grid>
